...
import com.example.ecommerce_app.adapters.CartProductsAdapter
...
import com.example.ecommerce_app.util.VerticalItemDecoration
...
class CartFragment: Fragment(R.layout.fragment_cart) {
                ...
                when (it){
                    ...
                    is Resource.Success -> {
                        ...
                        if (it.data!!.isEmpty()){
                            ...
                            hideEmptyCart()
                            showOtherViews(it.data, cartAdapter)
                        }
                    }
                    is Resource.Error -> {
                        binding.progressbarCart.visibility = View.INVISIBLE
    ...
    private fun showOtherViews(data: List<CartProduct>, cartAdapter: CartProductsAdapter) {
        binding.apply {
